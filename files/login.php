...
if(isset($btn))
{
$qry=mysql_query("select * from md_hospital where uname='$uname' && pass='$pass'");
$num=mysql_num_rows($qry);
	if($num==1)
	{
	$_SESSION['uname']=$uname;
	header("location:hos_home.php");
	}
	else
	{
	$msg="Login Incorrect!";	
	 ...
	 <div class="container mtb">
	 	<div class="row">
	 		...
	 		<div class="col-lg-8">
	 			<! -- Blog Post 1 -->
				<h3> Login</h3>
				<p><img src="assets/img/ext.jpg" width="771" height="390" class="img-responsive"></p>
