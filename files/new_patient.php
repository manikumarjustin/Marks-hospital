	 ...
	 ***************************************************************************************************************** -->
	 ...
	 <div class="container mtb">
	 	<div class="row">
	 		...
	 		<div class="col-lg-8">
	 			<! -- Blog Post 1 -->
				<h3>New Patient (<a href="add_patient.php">Add Patient</a>) </h3>
		 		
	 			<?php
				
				$qry=mysql_query("select * from md_patient where hname='$uname' && status=0 order by id desc");
				...
				?>
		 		<table width="727" height="59" border="1">
                  ...
                  <tr>
                    ...
                    <td><a href="assign.php?pid=<?php echo $row['id']; ?>">Assign Doctor</a></td>
                  </tr>
				  <?php
				  }
