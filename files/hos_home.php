	 		...
	 		<div class="col-lg-8">
				...
				<form name="form1" method="post">
				  ...
				  <div class="form-group">
					    ...
					    <input type="text" name="rdate" class="form-control" value="<?php echo $rdate; ?>">
				...
				if(isset($btn))
				{
				$qry=mysql_query("select * from md_patient where rdate='$rdate' order by id");
				...
				?>
		 		<table width="727" height="59" border="1">
                  ...
                  <tr>
                    ...
                    <td><a href="view_pat.php?pid=<?php echo $row['id']; ?>">Click</a></td>
                  </tr>
				  <?php
				  }
