	 ...
	 <div class="container mtb">
	 	<div class="row">
	 		...
	 		<div class="col-lg-8">
				...
				$qry=mysql_query("select * from md_appoint order by id desc");
				...
				?>
		 		<table width="813" height="59" border="1">
                  <tr>
                    <th width="54" class="bg-info">Sno</th>
                    <th width="104" class="bg-info">Doctor</th>
                    <th width="115" class="bg-info">Patient</th>
                    <th width="133" class="bg-info">Appoint Date</th>
                    <th width="119" class="bg-info">Time</th>
                    <th width="96" class="bg-info">Amount</th>
                    <th width="146" class="bg-info">Book Date </th>
                  </tr>
				  <?php
				  $i=0;
